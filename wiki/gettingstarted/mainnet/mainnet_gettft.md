...
1. Get TFT from a public [__digital currency exchange__](threefold:how_to_buy) *(with some limitations for certain countries)*
2. Get TFT through a [__Stellar decentralized exchange__](threefold:how_to_buy)
3. Purchase TFT directly from a [__ThreeFold Farmer__](threefold:how_to_buy)
...
> Please go to [__How to Buy TFT__](threefold:how_to_buy) Section on ThreeFold Wiki for more detailed information on purchasing TFT.