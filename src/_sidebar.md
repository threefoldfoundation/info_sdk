...
* [Getting Started](getting_started_all.md)
 - [Start on MainNet](getting_started_mainnet.md)
    ...
    - [Get a 3Bot](mainnet_3bot.md)
 - [Start on TestNet](getting_started_testnet.md)
    - [Get 3Bot Connect](3botconnect_install.md)
    - [Get a Stellar Wallet Testnet](testnet_stellar.md)
         - [Interstellar Wallet](interstellar_wallet.md)
         - [Solar Wallet](Solar_wallet.md)
    - [Get a 3Bot Testnet](getting_started_3bot.md)
    - [Try TF Grid Demo Testnet](getting_started_marketplace.md)
